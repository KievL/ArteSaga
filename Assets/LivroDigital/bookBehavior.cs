...
public class bookBehavior : MonoBehaviour
{
    ...
    //Este método retira os bloqueios das páginas do livro. Os bloqueios são gameobjects que sobrepoem as
    //imagens do livro, dando a impressão que as páginas estão vazias, ou que o conteúdo referente a cada
    //época ainda não foi desbloqueado. Cada época tem um inteiro salvo nos PlayerPrefs. Esse inteiros
    //são modificados toda vez que um conteúdo é desbloqueado durante o jogo. Esse método lê esses inteiros
    //e, dependendo do seu valor, tiram ou botam o bloqueio nas páginas.
    ...
    //Abre o livro na primeira página. Este método está sendo invocado no Event System do botão do livro
    ...
    //Passa para o próxima página do livro. Este método está sendo invocado no Event System do botão direito do livro.
    ...
    //Volta para a página anterior do livro. Este método está sendo invocado no Event System do botão esquerdo do livro.
    ...
    //Esse método é invocado toda vez que o jogador abre algum conteúdo do livro. Ele serve pra desativar todos os bloqueios
    //e todos os botões do livro.
    ...
    //Tira as setas. É chamado quando o livro é fechado ou quando o jogador abre algum conteúdo do livro.
    void tirarSetas()
    {
        setaDireita.SetActive(false);
        setaEsquerda.SetActive(false);
    ...
    //É chamado toda vez que o jogador fecha algum conteúdo do livro.
